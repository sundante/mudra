...
const _OutgoingcategoryValueEnumMap = {
  ...
  1: OutgoingCategory.insurance,
  2: OutgoingCategory.utility,
  3: OutgoingCategory.subscription,
  4: OutgoingCategory.sip,
  5: OutgoingCategory.ppf,
  6: OutgoingCategory.epf,
  7: OutgoingCategory.nps,
  8: OutgoingCategory.other,
};
